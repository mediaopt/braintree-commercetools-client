...
/* export default function NotificationBanner() {
  return (
    <div className="fixed inset-x-0 bottom-0 pb-2 sm:pb-5 ">
      <div className="mx-auto max-w-3xl px-2 sm:px-6 lg:px-8 ">
        <div className="rounded-lg bg-neutral-700 p-2 shadow-lg dark:bg-neutral-100 sm:p-3 ">
          <div className="flex flex-wrap items-center justify-between">
            <div className="flex w-0 flex-1 items-center">
              <span className="flex rounded-lg bg-green-500 p-2">
                <CheckIcon className="h-6 w-6 text-white" aria-hidden="true" />
              </span>
              <p className="ml-3 truncate font-medium text-white dark:text-neutral-900">
                <span className="md:hidden">Invintation sent</span>
                <span className="hidden md:inline">
                  User invintation successfully sent
                </span>
              </p>
            </div>
            <div className="flex-shrink-0 sm:order-3 sm:ml-2">
